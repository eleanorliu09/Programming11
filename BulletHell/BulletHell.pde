...
// powerups
PImage potion, heart, lightning, jewel;
int jewelCount, heartCount;
PImage redheart, heartcluster;
int protectCount;
boolean isPowerUp;
...
void setup() {
  ...
  heartcluster = loadImage("heartcluster.png");
